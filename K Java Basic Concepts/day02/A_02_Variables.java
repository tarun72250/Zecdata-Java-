...
public class A_02_Variables 
{
	public static void main(String[] args) 
	{
				...
				*/
				...
				int myNum = 15654; // Java is case sensitive because myNum or mynum both are different.
				System.out.println(myNum);//15654
					
				int sourabh;//declaration
				sourabh = 10;//initilization
				System.out.println("old sourabh value :"+sourabh);//old sourabh value :10
				
				sourabh =15;
				System.out.println("new sourabh value :"+sourabh);//new sourabh value :15
				
		        //non-primitive datatype
		        //Create a variable called name of type String and assign it the value "John":
				//String :- Sequnce of characters
		        String name;//decalartion
				 ...
				 */
				final int sumit1;//decalartion
			    sumit1 = 9;//initlization
				...
				boolean myBool = true;
				String myText = "Hello";
				System.out.println(sourabh1);//concatenation
				System.out.println(myLetter);
				
		        /*
		        Note :- 
		        All primitive datatype sizes are fixed.
		        but Non-primitve datatype their sizes may vary at runtime.
		        */
			    char ch1 = 'a';//2 byte
			    String str1 = "mohan";//10byte
			    String str2 = "ram";//6byte
			    String str3 = "sohan Chandra";//26byte
				 ...
				 */
				String msg = "Aniket Sarsaiya";
				System.out.println("Hello " + msg);   // Hello Aniket Sarsaiya
